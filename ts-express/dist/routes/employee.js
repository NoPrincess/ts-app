...
var urlencodeParser = body_parser_1.default.urlencoded({ extended: false });
...
router.post("/createEmployee", urlencodeParser, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
